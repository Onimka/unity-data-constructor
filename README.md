...
It’s designed to simplify and speed up your configuration workflow — ideal for designers and developers alike.
...
- 🧩 **Template-based** system for defining reusable data structures
- 📋 **List support** with reorder and inline editing
- 🧬 Full support for **nested fields** and complex types
- 🔗 **External field references** across different templates
- 💾 Import/export system with **JSON serialization**
- 🖱️ Clean, intuitive, and scalable UI
...
<img width="1744" height="747" alt="List Support" src="https://github.com/user-attachments/assets/23b1b6ac-2571-40af-9277-238b043ba03c" />
...
1. **Create serializable C# classes** to define your data templates.  
...
2. **Add Fields** to the template via the editor interface.

3. **Create a Data File** and start adding entries.  
...
4. **Auto-generate C# code** and the final JSON data file.

5. **At runtime**, your game automatically loads and parses the data from the generated JSON.
...
- 🧩 Unity asset drag-and-drop support
...
**Follow the project** and ⭐️ it if you're interested!  
